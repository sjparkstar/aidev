...
export default function ResponsiveRoadmapBoard() {
          ...
          {sidebarOpen ? (
            <>
              <div className="flex items-center space-x-3">
                ...
                <span className={`font-semibold ${isMobile ? 'text-sm' : ''}`}>RemoteCall Manager</span>
              </div>
              <button 
                onClick={() => setSidebarOpen(false)}
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            <div>
              ...
              >
                <div 
                  onClick={() => {
                    selectMenu('redmine-all-issues');
                    if (isMobile) setSidebarOpen(false);
                  }}
                  className={`text-sm py-2 px-3 rounded cursor-pointer transition-colors min-h-[44px] flex items-center ${
        ...
        <div className="bg-white border-b border-gray-200 px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`${isMobile ? 'text-lg' : 'text-xl'} font-semibold text-gray-900`}>{currentMenuInfo.title}</h1>
                {!isMobile && (
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          {selectedMenu === 'login-management' ? (
            <div className="space-y-4 md:space-y-6">
                ...
                <div className="p-4 border-b border-gray-200 bg-gray-50">
                  ...
                  <div className={`${
                    ...
                    <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-2">
                      ...
                      />
                      <button className="bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-700 min-h-[44px] whitespace-nowrap">
                        검색
                      </button>
                    </div>
                  </div>
              ...
              {/* 선택된 버전의 이슈 목록 (RoadmapBoard 스타일) */}
              {selectedVersion && (
                <div className="bg-white rounded-lg border border-gray-200">
